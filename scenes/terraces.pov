...
height_field
{
 ...
 //  	water_level 0.05 // truncate/clip below N (0.0 ... 1.0)
	...
	height_field
	{
		...
		translate <-.5, 0.0, -.5>
	texture {
		pigment {color rgbt<0.0,water_density*0.15,water_density*0.35,0.5>}
	
	normal {bumps 0.0001 scale <0.003,1,0.001> }
	finish {specular 0.4 roughness 0.05
		reflection 0.4 ambient 0.1 diffuse 0.8}
	}
	}
#end
...
object {hf scale <1,1,1> translate y*0 texture {slope_rock_bushes scale <0.5,1,0.5> } }

#ifdef (water)
	object {water scale <1,0.95,1>}
#end
